      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="max-w-4xl">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 text-balance">
            Construction, Engineering &amp; Cleaning Services in KZN
          </h1>
          <p className="text-white/70 text-lg md:text-xl leading-relaxed max-w-3xl">
            We provide comprehensive infrastructure, construction, and cleaning services 
            tailored to meet the evolving needs of clients across KwaZulu-Natal.
          </p>
        </div>
      </div>
    </section>
